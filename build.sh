...
ZIP_URL="https://cosmo.zip/pub/cosmos/bin/zip"
SQLITE_URL="https://cosmo.zip/pub/cosmos/bin/sqlite3"
...
_Init () {
    ...
    umask $u;
    _Fetch "eff_large_wordlist.txt" https://www.eff.org/files/2016/07/18/eff_large_wordlist.txt
